...
관련 문서(3단계에서 판단한 후보) 본문이 대략 **400~500줄**을 넘었으면(진행 이력이 쌓여 지침과 이력이 뒤섞인 징후), 6단계 보고에 한 줄 추가한다:

```
[문서 비대화] <파일> N줄 — 지침만 남기고 이력은 docs/history/로 이관 고려 (2026-08-02 Easy CAD 선례)
```
